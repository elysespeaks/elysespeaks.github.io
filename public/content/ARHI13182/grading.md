...
| Components | Weight |
|-----------|--------|
| Five short **visual-analysis assignments** (1–2 pp. each) – first draft, peer review, final draft | **25 %** |
...
All work must follow the Notre Dame Academic Code of Honor (“I will not participate in or tolerate academic dishonesty”). **Generative-AI tools are prohibited** from use for all graded assignments in this course; use will result in failing the assignment and other actions. See <http://honorcode.nd.edu>.
