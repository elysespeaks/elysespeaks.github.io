...
Attendance is required in this class; some form of written excuse is needed after 2 absences unless the situation is discussed in advance with me. The course will be conducted as a seminar, so active participation is a necessary component of the course. Remember, there are no silly questions in this class, and sometimes the most basic questions and observations are the most interesting.

### Goals and objectives:

- To be visually and critically informed about a part of the collection of the Art Institute of Chicago.
- To be able to identify and describe key historical periods and styles in modern art.
- To be able to understand and critically explain the context and circumstances that precipitated the changes that took place across the 19th and 20th centuries in art.
- To be able to use that information to construct and critique visual and historical arguments about art by:
  - Taking a position on an issue related to visual subjects.
  - Raising and answering arguments related to primary and secondary sources on art and art history.
  - Writing effectively on art historical topics.

### Texts

All readings will be made available by PDF, and can be downloaded from the syllabus page on this site. To download, simply right-click on the link and 'save as' to your desktop or course file that you've created. I very strongly recommend printing out the pages that we'll be covering from each reading (note that nearly all the pdf. files are much longer than the page numbers that have been assigned; be sure to pay attention to the page numbers that appear on the syllabus and handouts).
